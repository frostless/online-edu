...
class API {
  ...
  static getStudentList(param) {
    return REST.get(`student/list${objectToUrl(param)}`);
  }
  ...
  static getCourseList(param) {
    return REST.get(`course/list${objectToUrl(param)}`);
  }
  ...
  static getStudentCourseList(param) {
    return REST.get(`student/course/list${objectToUrl(param)}`);
  }
